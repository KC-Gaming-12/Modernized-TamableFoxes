package net.seanomik.tamablefoxes.versions.version_26_1_R1.pathfinding;
...
import net.seanomik.tamablefoxes.versions.version_26_1_R1.NMSUtil;
import org.bukkit.GameRule;
import org.bukkit.event.entity.EntityTargetEvent.TargetReason;
import net.seanomik.tamablefoxes.versions.version_26_1_R1.EntityTamableFox;
...
public class FoxPathfinderGoalHurtByTarget extends TargetGoal {
    ...
    public boolean canUse() {
        ...
        if (i != this.timestamp && entityliving != null) {
            if (entityliving.getType() == EntityType.PLAYER && Boolean.TRUE.equals(
